...
from database.models import get_chat_settings, set_user_afk
from services.image_processor import process_sticker
...
async def show_rules(update: Update, context: ContextTypes.DEFAULT_TYPE):
    settings = get_chat_settings(update.message.chat_id)
...
async def set_afk(update: Update, context: ContextTypes.DEFAULT_TYPE):
    ...
    set_user_afk(update.message.from_user.id, reason)
...
async def kang_sticker(update: Update, context: ContextTypes.DEFAULT_TYPE):
    ...
    try:
        ...
        bio, filename = process_sticker(file_bytes, is_video)

        # Send sticker back to chat
